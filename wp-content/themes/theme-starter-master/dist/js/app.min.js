...
var SITE=(jQuery,{init:function(){},anotherOne:function(){}});$(document).ready(function(){SITE.init(),SITE.anotherOne();new Swiper(".swiper-container",{direction:"horizontal",loop:!0,slidesPerView:1,centeredSlides:!0,pagination:{el:".swiper-pagination"}})}),console.log("hello");