(function( $ ) {
	 ...
	 */ 
        ...
        $(document).ready(function(){
            ...
            $('#addField, .addField').click(function(){
                ...
                if(fieldName != ''){
                    ...
                    if(fieldType=='text' || fieldType=='email' || fieldType=='date' || fieldType == 'text_area'|| fieldType == 'file' || fieldType == 'separator' || fieldType == 'paragraph'){
                        style = "display:none";
                    }
                    else {
                        style = "";
            ...
            $('.aol-settings').find('.tab-data:first').show();
            $('.aol-settings').find('.nav-tab').click(function(){
                $('.aol-settings').find('.nav-tab').removeClass('nav-tab-active');
                $(this).addClass('nav-tab-active');

                var target = $(this).data("id");

                $('.aol-settings').find('.tab-data').hide();
                $("#"+target).show();
            });
