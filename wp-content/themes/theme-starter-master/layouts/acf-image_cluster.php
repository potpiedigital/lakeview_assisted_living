<section class="main-image-container">
  <div class='inner-image-container'>
    <img class="top-image" src="<?php the_sub_field('top_image'); ?>" />
    ...
    <div class="image-info">
      <h4><?php the_sub_field('image_copy'); ?></h4>
      <a class="button" href="<?php the_sub_field('image_cta_link') ?>"><?php the_sub_field('image_cta_text'); ?></a>
    </div>
  <div>
</section>
